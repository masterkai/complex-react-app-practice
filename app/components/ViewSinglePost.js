...
import StateContest from '../StateContext'
import DispatchContest from '../DispatchContext'

const ViewSinglePost = (props) => {
  const appState = useContext(StateContest)
  const appDispatch = useContext(DispatchContest)
  const {id} = useParams()
