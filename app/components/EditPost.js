      ...
      try {
        ...
        if (response.data) {
          ...
          if(appState.user.username != response.data.author.username) {
            appDispatch({type:'flashMessage', value:'You do not have the permission to edit that post.'})
    ...
    <Page title='Edit Post'>
      ...
      <form className='mt-3' onSubmit={submitHandler}>
        <div className="form-group">
          ...
          <input onBlur={event => dispatch({type: 'titleRules', value: event.target.value})}
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            onChange={e => dispatch({type: 'bodyChange', value: e.target.value})} value={state.body.value}
